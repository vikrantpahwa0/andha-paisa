...
import FooterBanner from "../ad-components/footer-banner";

export default function Footer() {
  return (
    <>
      {/* Banner Ad Below Footer */}
      <FooterBanner />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-500 text-sm mb-4 max-w-md">
                Earn real cash rewards by completing surveys, trying offers, and
                playing games. Turn your free time into valuable payouts with
                CashCash.
              </p>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    ...
                    className="text-slate-500 hover:text-green-600 text-sm transition"
                  >
